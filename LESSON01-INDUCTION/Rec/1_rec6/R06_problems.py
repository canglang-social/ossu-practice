...
# INSERT CODE HERE
new_list1 = [x for x in original_list if x % 5 != 0]
...
# INSERT CODE HERE
new_list2 = [x / 2 for x in original_list]
...
def split_list(lst, n):
    ...
    # INSERT CODE HERE
    new_list = []
    my_range_num = len(lst) // n
    if len(lst) % n != 0:
        my_range_num += 1
    for i in range(my_range_num):
