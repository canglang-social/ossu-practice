...
# =============================================================================
print(
    SimpleWorkout.__dict__.keys()
)  # dict_keys(['__module__', '__init__', 'get_calories', 'get_start', 'set_calories', 'set_start', '__dict__', '__weakref__', '__doc__'])
print()
print(SimpleWorkout.__dict__.values())

my_workout = SimpleWorkout("9/30/2021 1:35 PM", "9/30/2021 1:57 PM", 200)
print(
    my_workout.__dict__.keys()
...
print(type(end_date - start_date))  # is the repr of a datetime obj
...
w_one = Workout("Jan 1 2021 3:35PM", "Jan 1 2021 4:00PM", 300)
print(w_one.get_calories())
...
class RunWorkout(Workout):
    ...
    def __init__(self, start, end, elev=0, calories=None, route_gps_points=None):
        ...
        and elev is the total elevation gain in the workout in feet,
...
# =============================================================================
print(
    RunWorkout.__dict__.keys()
)  # dict_keys(['__module__', 'cals_per_km', '__init__', 'get_elev', 'get_calories', '__eq__', '__doc__', '__hash__'])
print()
workout1 = RunWorkout("9/30/2021 1:35 PM", "9/30/2021 1:57 PM", calories=450, elev=200)
print(
    workout1.__dict__.keys()
)  # dict_keys(['start', 'end', 'icon', 'kind', 'calories', 'elev', 'route_gps_points'])
...
def total_elapsed_time(L):
    ...
    sum = 0
    for start, end in L:
        sum += (parser.parse(end) - parser.parse(start)).total_seconds()
    return sum
