...
# your code here
increment_value = float(input("type a value: "))
print(increment_value == 0.022)
x = increment_value
count = 1
while x == count * increment_value:
    count += 1
    x += increment_value
print(
    f"different when {count - 1}: {x - increment_value} != {(count - 1) * increment_value}"
)
