...
class Mortgage(object):
    ...
    # 净成本随时间变化 -- 实际上就是每月支付的利息（也就是净成本）累加
...
def plotMortgages(morts, amt):
    ...
    labelPlot(
        payments,
        "Monthly Payments of $" + str(amt) + " Mortgages",
        "Months",
        "Monthly Payments",
    )
    labelPlot(
        cost,
        "Cash Outlay of $" + str(amt) + " Mortgages",
        "Months",
        "Total Payments",
    )
    labelPlot(
        balance,
        "Balance Remaining of $" + str(amt) + " Mortgages",
        "Months",
        "Remaining Loan Balance of $",
    )
    labelPlot(
        netCost,
        "Net Cost of $" + str(amt) + " Mortgages",
        "Months",
        "Payments - Equity $",
    )
