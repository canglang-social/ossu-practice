...
class Vehicle:
    """A vehicle has wheels_num,occupants,color"""
...
v1 = Vehicle(2, ["Felix", "red"])
v2 = Vehicle(18, ["f", "d", "c"], "green")
print(len(v1.getOccupants()))
print(v2.getColor())
# Question 3:
...
class Vehicle(object):
    ...
    def add_n_occupants(self, n):
        ...
        Args:
            n:int
        Returns:
            int, number of occupants after the increase"""
        self.occ += n
        return self.occ
...
class Vehicle(object):
    ...
    def add_n_occupants(self, n):
        ...
        if self.occ + n > self.max_occupancy:
            raise ValueError("increase too more!")
        else:
            self.occ += n
        return self.occ
