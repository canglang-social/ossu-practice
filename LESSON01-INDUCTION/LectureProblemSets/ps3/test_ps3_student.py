...
class TestPrepData(unittest.TestCase):
    def test_prep_hello_world(self):
        ...
        result = ds.text_to_list(
            load_text("LectureProblemSets/ps3/tests/student_tests/hello_world.txt")
        )
    ...
    def test_prep_1a(self):
        expected = a1
        result = ds.text_to_list(
            load_text("LectureProblemSets/ps3/tests/student_tests/test1a.txt")
        )
        self.assertEqual(result, expected)
...
class TestWordFrequency(unittest.TestCase):
    ...
    def test_frequency_hello_world(self):
        text = load_text("LectureProblemSets/ps3/tests/student_tests/hello_world.txt")
    ...
    def test_frequency_1a(self):
        text = load_text("LectureProblemSets/ps3/tests/student_tests/test1a.txt")
        data = a1
        result = ds.get_frequencies(data)
        expected = a1_freq
        self.assertDictEqual(result, expected)
    ...
    def test_frequency_1b(self):
        text = load_text("LectureProblemSets/ps3/tests/student_tests/test1b.txt")
        data = b1
        result = ds.get_frequencies(data)
        expected = b1_freq
        self.assertDictEqual(result, expected)
...
class TestTFIDF(unittest.TestCase):
    ...
    def test_tf1(self):
        text_file = "LectureProblemSets/ps3/tests/student_tests/hello_world.txt"
    ...
    def test_tf2(self):
        text_file = "LectureProblemSets/ps3/tests/student_tests/test1a.txt"
        result = ds.get_tf(text_file)
        expected = tf2_dict
        self.assertDictAlmostEqual(result, expected)
    ...
    def test_idf1(self):
        text_files = [
            "LectureProblemSets/ps3/tests/student_tests/hello_world.txt",
            "LectureProblemSets/ps3/tests/student_tests/hello_friends.txt",
        ]
    ...
    def test_idf2(self):
        text_files = [
            "LectureProblemSets/ps3/tests/student_tests/test1a.txt",
            "LectureProblemSets/ps3/tests/student_tests/test1b.txt",
        ]
        result = ds.get_idf(text_files)
        expected = idf2_dict
        self.assertDictAlmostEqual(result, expected)
    ...
    def test_tfidf_big(self):
        ...
        text_files = [
            "LectureProblemSets/ps3/tests/student_tests/test1a.txt",
            "LectureProblemSets/ps3/tests/student_tests/test1b.txt",
            "LectureProblemSets/ps3/tests/student_tests/test2a.txt",
            "LectureProblemSets/ps3/tests/student_tests/test2b.txt",
            "LectureProblemSets/ps3/tests/student_tests/test3a.txt",
        ]
        result = ds.get_tfidf(text_file, text_files)
        expected = tfidf_list
        self.assertListAlmostEqual(result, expected)
