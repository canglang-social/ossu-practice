...
class TestPS4A(unittest.TestCase):
    ...
    def test_data_representation(self):
        ...
        self.assertTrue(
            str(student_t1) == str_representation[0],
            "\nYour Tree: \n{}\nCorrect Tree\n{}".format(
                student_t1, str_representation[0]
            ),
        )
        self.assertTrue(
            str(student_t2) == str_representation[1],
            "\nYour Tree: \n{}\nCorrect Tree\n{}".format(
                student_t2, str_representation[1]
            ),
        )
        self.assertTrue(
            str(student_t3) == str_representation[2],
            "\nYour Tree: \n{}\nCorrect Tree\n{}".format(
    ...
    def test_tree_height(self):
        ...
        tr1 = Node(
            13,
            Node(10, Node(5, Node(4), Node(6)), Node(11)),
            Node(15, right_child=Node(16, Node(3, Node(20, Node(17))))),
        )
        tr2 = Node(
            37,
            Node(24, Node(7, Node(2, right_child=Node(5))), Node(32)),
            Node(
                42,
                Node(40),
                Node(42, right_child=Node(43, Node(2, Node(14, Node(30))))),
            ),
        )
    ...
    def test_is_min_heap(self):
        tr1 = Node(
            5,
            Node(15, None, Node(16, Node(30), Node(17))),
    ...
    def test_is_max_heap(self):
        tr1 = Node(
            15,
            Node(4, Node(3, None, Node(2)), Node(1)),
