...
def count_nums_with_sqrt_close_to(n, epsilon):
    ...
    # your code here
    num = 0
    for i in range(int((n + epsilon) ** 2) + 1):
        print(i, i**2, (n - epsilon) ** 2, (n + epsilon) ** 2)
        if (i**2 > int((n - epsilon) ** 2)) and (i**2 < int((n + epsilon) ** 2)):
            num += 1
    return num
...
print(5 + func_b(2))  # "inside func_b" 7
print(func_c(func_b, 3))  # "inside func_c" "inside func_b" 3
