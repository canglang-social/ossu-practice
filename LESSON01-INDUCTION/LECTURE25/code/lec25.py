...
phoenix = [54, 57, 61, 68, 77, 86, 91, 90, 84, 73, 61, 54]
plt.plot(months, phoenix, label="Phoenix", color="r", linestyle="--")
msp = [16, 19, 34, 48, 59, 70, 75, 73, 64, 60, 37, 21]
plt.plot(months, msp, label="Minneapolis", color="g", linestyle="-.")
plt.legend(loc="best", fontsize=20)
plt.title("Ave. Temperatures")
plt.xlabel("Month")
plt.ylabel(("Degrees F"))
...
dates, pops = getUSPop("LECTURE25/code/lec25_USPopulation.txt")
plt.plot(dates, pops)
